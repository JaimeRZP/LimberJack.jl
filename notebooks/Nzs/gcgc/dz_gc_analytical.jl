...
@everywhere @model function model(data;
    ...
    DESgc__0_dz = 0.0 #~ TruncatedNormal(0.0, 0.007, -0.2, 0.2)
    DESgc__1_dz = 0.0 #~ TruncatedNormal(0.0, 0.007, -0.2, 0.2)
    DESgc__2_dz = 0.0 #~ TruncatedNormal(0.0, 0.006, -0.2, 0.2)
    DESgc__3_dz = 0.0 #~ TruncatedNormal(0.0, 0.01, -0.2, 0.2)
    DESgc__4_dz = 0.0 #~ TruncatedNormal(0.0, 0.01, -0.2, 0.2)
...
folname = string("dz_gc_analytical_", "TAP_", TAP)
