...
@everywhere @model function model(data;
    ...
    DESwl__0_dz ~ TruncatedNormal(0.0, 0.2*0.017, -0.8, 0.8)
    DESwl__1_dz ~ TruncatedNormal(0.0, 0.2*0.017, -0.8, 0.8)
    DESwl__2_dz ~ TruncatedNormal(0.0, 0.2*0.013, -0.8, 0.8)
    DESwl__3_dz ~ TruncatedNormal(0.0, 0.2*0.015, -0.8, 0.8)
...
# Start sampling.
folpath = "../../chains/Nzs_chains/tight_runs/"
folname = string("dz_LSST_numerical_lite_tight_correct_nzs_", "TAP_", TAP)
