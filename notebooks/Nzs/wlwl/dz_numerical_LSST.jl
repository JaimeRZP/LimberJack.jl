...
@everywhere @model function model(data;
    ...
    DESwl__0_dz ~ TruncatedNormal(0.0, 0.017, -0.8, 0.8)
    DESwl__1_dz ~ TruncatedNormal(0.0, 0.017, -0.8, 0.8)
    DESwl__2_dz ~ TruncatedNormal(0.0, 0.013, -0.8, 0.8)
    DESwl__3_dz ~ TruncatedNormal(0.0, 0.015, -0.8, 0.8)
...
folname = string("dz_LSST_numerical_custom_nz_lite_", "TAP_", TAP)
